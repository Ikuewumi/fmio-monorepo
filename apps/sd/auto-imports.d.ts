...
export {}
declare global {
  const $systemTheme: typeof import('./src/composables/store')['$systemTheme']
  ...
  const allThemes: typeof import('./src/composables/store')['allThemes']
  ...
  const getNextTheme: typeof import('./src/composables/store')['getNextTheme']
