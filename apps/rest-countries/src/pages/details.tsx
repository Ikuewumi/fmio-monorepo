...
import { getCountryData, getCtyNameFromAcronym, fNum } from "../api";
                ...
                <section class="det-main">
                    ...
                    <article class="content">
                        ...
                        <div class="grp basic">
                            ...
                            <p><b>Native Name: </b>{ctyData().nativeName}</p>
                            <p><b>Population: </b>{fNum(ctyData().population)}</p>
                        ...
                        <div class="grp extra">
                            ...
                            <p><b>Currencies: </b>{ctyData().currencies.map(curr => curr.name).join(', ')}</p>
                            <p><b>Languages: </b>{ctyData().languages.map(lang => lang.name).join(', ')}</p>
                        </div>
